...
describe TeamMembersController do
  ...
  describe "GET index" do
    it "assigns all team_members as @team_members" do
      ...
      assigns(:team_members).should eq([team_member])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested team_member as @team_member" do
      ...
      assigns(:team_member).should eq(team_member)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new team_member as @team_member" do
      ...
      assigns(:team_member).should be_a_new(TeamMember)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created team_member as @team_member" do
        post :create, {:team_member => valid_attributes}, valid_session
        assigns(:team_member).should be_a(TeamMember)
        assigns(:team_member).should be_persisted
      end

      it "redirects to the created team_member" do
        post :create, {:team_member => valid_attributes}, valid_session
        response.should redirect_to(TeamMember.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved team_member as @team_member" do
        ...
        TeamMember.any_instance.stub(:save).and_return(false)
        post :create, {:team_member => { "team" => "invalid value" }}, valid_session
        assigns(:team_member).should be_a_new(TeamMember)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested team_member" do
        team_member = TeamMember.create! valid_attributes
        # Assuming there are no other team_members in the database, this
        # specifies that the TeamMember created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        TeamMember.any_instance.should_receive(:update_attributes).with({ "team" => "" })
        put :update, {:id => team_member.to_param, :team_member => { "team" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the team_member as @team_member" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TeamMember.any_instance.stub(:save).and_return(false)
        put :update, {:id => team_member.to_param, :team_member => { "team" => "invalid value" }}, valid_session
        assigns(:team_member).should eq(team_member)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the team_members list" do
      team_member = TeamMember.create! valid_attributes
      delete :destroy, {:id => team_member.to_param}, valid_session
      response.should redirect_to(team_members_url)
    end
  end
