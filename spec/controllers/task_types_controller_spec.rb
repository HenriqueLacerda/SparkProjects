  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved task_type as @task_type" do
        ...
        post :create, {:task_type => { "nome" => "invalid value" }}, valid_session
        assigns(:task_type).should be_a_new(TaskType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested task_type" do
        ...
        TaskType.any_instance.should_receive(:update_attributes).with({ "nome" => "MyString" })
        put :update, {:id => task_type.to_param, :task_type => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the task_type as @task_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TaskType.any_instance.stub(:save).and_return(false)
        put :update, {:id => task_type.to_param, :task_type => { "nome" => "invalid value" }}, valid_session
        assigns(:task_type).should eq(task_type)
      end
